<?php
	...
	$book_no = "";
	$student_name = "";
	$query = "select issued_books.book_name,issued_books.book_author,issued_books.student_id,issued_books.book_no,users.name from issued_books left join users on issued_books.student_id = users.id where issued_books.status = 1";
?>
<!DOCTYPE html>
<html lang="en">
...
<body  style="overflow: auto;">
	...
	<div class="row">
		<span style="color:aqua;"><center><h3><u>Issue Book's Detail</u></h3><br></center></span>
