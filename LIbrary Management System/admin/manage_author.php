...
<body  style="overflow: auto;">
	...
	<div class="row">
        ...
        <div class="col-md-8">
            ...
            <center><h3><u>MANAGE AUTHOR</u></h3><br></center></span>
				<form>
					<table class="table-bordered" style="margin:auto;">
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" style="border:none;" name=""><a href="edit_author.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
								<button class="btn" style="border:none;"><a href="delete_author.php?aid=<?php echo $row['author_id'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
