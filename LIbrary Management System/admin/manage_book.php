...
<body  style="overflow: auto;">
	...
	<div class="row">
        ...
        <div class="col-md-8">
            ...
            <center><h3><u>Manage Books</u></h3><br></center></span>
					...
					<table class="table-bordered" style="margin:auto;">
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" style="border:none;" name=""><a href="edit_book.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn" style="border:none;"><a href="delete_book.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
