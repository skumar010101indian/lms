...
<body  style="overflow: auto;">
	...
	<div class="row">
        ...
        <center>
            <h2 style=" color: lightgreen;"> <u>Edit Book</u> </h2>
        </center>
        <form action="" method="post">
					<div class="form-group">
						<label for="mobile"><b>Book Number:</b></label>
					...
					<div class="form-group">
						<label for=""><b>Book Price:</b></label>
            ...
            <button type="submit" name="update"class="btn btn-primary">&nbsp;&nbsp;&nbsp;<b>Update Book</b>&nbsp;&nbsp;&nbsp;</button>
        </form>
