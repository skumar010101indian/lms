...
<body  style="overflow: auto;">
	...
	<div class="row">
        ...
        <div class="col-md-8">
            ...
            <center><h3><u>MANAGE CATEGORY</u></h3><br></center></span>
				<form>
					<table class="table-bordered" style="margin:auto;">
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" style="border:none;"><a href="edit_cat.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
								<button class="btn" style="border:none;"><a href="delete_cat.php?cid=<?php echo $row['cat_id'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
