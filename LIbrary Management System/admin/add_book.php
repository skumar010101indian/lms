...
<body  style="overflow: auto;">
	...
	<div class="row">
        ...
        <center>
            <h2 style=" color: lightgreen;"> <u> ADD NEW BOOKS</u> </h2>
        </center>
        <form action="" method="post">
					...
					<div class="form-group">
						<label for="mobile"><b>Author Name:</b></label>
						<input type="text" name="book_author" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="mobile"><b>Book Category:</b></label>
						<select name="book_category" class="form-control" required>
                            ...
                            <option value="Young Adult (YA) Fiction">Young Adult (YA) Fiction</option>
                            ...
                            <option value="Children Comics">Children Comics</option>
                            <option value="Children's Fiction">Children's Fiction</option>
                            <option value="Spiritual & Religious Texts">Spiritual & Religious Texts</option>
                            <option value="Travel & Geography">Travel & Geography</option>
                        </select>					</div>
					<div class="form-group">
						<label for="mobile"><b>Book Number:</label>
...
<?php
	if(isset($_POST['add_book']))
	{
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"lms");
		$query = "insert into books values(null,'$_POST[book_name]','$_POST[author_name]','$_POST[book_category]',$_POST[book_no],$_POST[book_price])";
		$query_run = mysqli_query($connection,$query);
