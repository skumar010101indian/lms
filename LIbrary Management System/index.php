...
<body>
  ...
  <div class="row">
    ...
    <div class="col-md-4" id="main_content">
      <center>
        <h2 style=" color: lightgreen;"> <u> User Login Form</u> </h2>
      </center>
      <form action="" method="post">
        <br>
          <img class="user_icon" src="images\user_icon.jpg" alt="">
        ...
        <a href="signup.php" style="color:lightgreen; margin-left:10px;">Not register yet ?</a>
      </form>
      <?php 
