...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="user_dashboard.php"><b><b>B</b>ook<b>K</b>eeper</b> - A library management system</a>
  ...
  <div class="row">
    ...
    <center>
        <h2 style=" color: lightgreen;"> <u> Change password</u> </h2>
      </center>
      <form action="update_password.php" method="post">
                    ...
                    <br>
					<div class="form-group">
						<label for="verify_Password"><b>Verify New Password:</b></label>
						<input type="password" name="verify_password" class="form-control">
					</div>
                    <br>
					<button type="submit" name="update" class="btn btn-primary"><b>Update Password</b></button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
